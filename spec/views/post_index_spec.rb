...
RSpec.describe 'Post Index', type: :feature do
  before(:each) do
    ...
    @post1 = @test1.posts.create(user_id: @test1.id, comments_counter: 1, likes_counter: 13, title: 'test post 1', text: 'This is test post 1', created_at: Time.now)
    @test1.posts.create(user_id: @test1.id, comments_counter: 0, likes_counter: 7, title: 'test post 2', text: 'This is test post 2', created_at: Time.now)
    @test1.posts.create(user_id: @test1.id, comments_counter: 0, likes_counter: 5, title: 'test post 3', text: 'This is test post 3', created_at: Time.now)
    @test1.posts.create(user_id: @test1.id, comments_counter: 0, likes_counter: 1, title: 'test post 4', text: 'This is test post 4', created_at: Time.now)
