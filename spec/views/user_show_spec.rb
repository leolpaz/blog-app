...
RSpec.describe 'User Show', type: :feature do
  before(:each) do
    ...
    @test1.posts.create(user_id: @test1.id, comments_counter: 0, likes_counter: 0, title: 'test post 1',
                        text: 'This is test post 1', created_at: Time.now)
    @test1.posts.create(user_id: @test1.id, comments_counter: 0, likes_counter: 0, title: 'test post 2',
                        text: 'This is test post 2', created_at: Time.now)
    @test1.posts.create(user_id: @test1.id, comments_counter: 0, likes_counter: 0, title: 'test post 3',
                        text: 'This is test post 3', created_at: Time.now)
    @test1.posts.create(user_id: @test1.id, comments_counter: 0, likes_counter: 0, title: 'test post 4',
