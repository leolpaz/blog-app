...
RSpec.describe 'Post Show', type: :feature do
  before(:each) do
    ...
    @test2 = User.create(name: 'Test2', photo: 'test_link2', email: 'test2@test.com', password: '123456',
                         posts_counter: 2, confirmed_at: Time.now)
    @post1 = @test1.posts.create(user_id: @test1.id, comments_counter: 2, likes_counter: 13, title: 'test post 1',
    ...
    @test2.comments.create(post_id: @post1.id, text: 'This is another test comment by another user',
                           created_at: Time.now)
