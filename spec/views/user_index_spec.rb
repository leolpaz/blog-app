...
RSpec.describe 'User Index', type: :feature do
  before(:each) do
    ...
    User.create(name: 'Test2', photo: 'test_link2', email: 'test2@test.com', password: '123456', posts_counter: 2,
                confirmed_at: Time.now)
    User.create(name: 'Test3', photo: 'test_link3', email: 'test3@test.com', password: '123456', posts_counter: 3,
                confirmed_at: Time.now)
